...
export default function CinematicThemeSwitcher() {
  ...
  if (!mounted) {
    return (
      <div className="relative inline-block w-[64px] h-[34px]">
        <div className="relative flex h-[34px] w-[64px] items-center rounded-full bg-gray-900 border border-gray-800 p-[3px]" />
      </div>
    );
  }

  return (
    <div className="relative inline-block w-[64px] h-[34px] z-50">
        ...
        style={{
          ...
          boxShadow: isDark
            ? `
              ...
              inset -5px -5px 12px rgba(71, 85, 105, 0.1),
              inset 8px 8px 16px rgba(0, 0, 0, 0.7),
              inset -8px -8px 16px rgba(100, 116, 139, 0.1),
              inset 0 2px 4px rgba(0, 0, 0, 1),
              inset 0 -2px 4px rgba(71, 85, 105, 0.2),
            ...
            `,
          border: isDark 
            ? '2px solid rgba(234, 179, 8, 0.2)' // matching var(--color-primary) #EAB308
      ...
      >
        ...
        <div 
          ...
          style={{
            boxShadow: isDark
              ? 'inset 0 2px 6px rgba(0, 0, 0, 0.9), inset 0 -1px 3px rgba(234, 179, 8, 0.2)'
        ...
        <div 
          ...
          style={{
            background: isDark
              ? `
                radial-gradient(ellipse at top, rgba(234, 179, 8, 0.05) 0%, transparent 50%),
                linear-gradient(to bottom, rgba(234, 179, 8, 0.1) 0%, transparent 30%, transparent 70%, rgba(0, 0, 0, 0.5) 100%)
              `
              : `
        ...
        <div className="absolute inset-0 flex items-center justify-between px-[6px]">
          <Sun size={14} className={isDark ? 'text-amber-500/50' : 'text-amber-600 font-bold'} />
          <Moon size={14} className={isDark ? 'text-amber-500 font-bold' : 'text-slate-700'} />
        </div>
        ...
        <motion.div
          ...
          style={{
            background: isDark
              ? 'linear-gradient(145deg, #EAB308 0%, #ca8a04 50%, #a16207 100%)' // Yellow!
              : 'linear-gradient(145deg, #ffffff 0%, #fefefe 50%, #f8fafc 100%)',
            boxShadow: isDark
              ? `
                inset 2px 2px 4px rgba(253, 224, 71, 0.4),
              ...
              `,
            border: isDark
              ? '2px solid rgba(254, 240, 138, 0.5)'
          ...
          transition={{
            type: 'spring',
            stiffness: 400, // Faster, snappy movement (up from 300)
            damping: 25, // Slightly stiffer bounce (up from 20)
          }}
        >
          ...
          <div 
            className="absolute inset-0 rounded-full pointer-events-none"
            style={{
              background: 'linear-gradient(to bottom, rgba(255, 255, 255, 0.6) 0%, transparent 40%, rgba(0, 0, 0, 0.2) 100%)',
              mixBlendMode: 'overlay',
            }}
          />
          ...
          {/* Icon */}
          <div className="relative z-10 text-white mix-blend-mode-difference drop-shadow-md">
            {isDark ? (
              <Moon size={14} className="text-black/80 stroke-[3px]" />
            ) : (
              <Sun size={14} className="text-amber-500 stroke-[3px]" />
            )}
          </div>
        </motion.div>
      </motion.button>
